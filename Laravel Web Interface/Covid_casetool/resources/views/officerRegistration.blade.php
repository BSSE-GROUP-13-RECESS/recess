...
@section('content')
  <div id="lop">
    <div class="row justify-content-center">
      <div class="col-md-8">
        <div class="card mt-5">
          <div class="card-header"><h3>{{ __('Health Officer Registration') }}</h3></div>
          <div class="card-body">
            <form>
              @csrf
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  <input id="name" type="text" class="form-control" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus oninput="verify()">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  <input id="username" type="text" class="form-control" name="username" value="{{ old('username') }}" required oninput="verify()">
  ...
  <div>
    <div class="row justify-content-center">
      <div class="col-md-8">
        <div class="card mt-5">
          <div class="card-header"><h3>{{ __('Register Hospital Heads') }}</h3></div>
          <div class="card-body">
            <p id="gens" hidden>{{$generals}}</p>
            <p id="regs" hidden>{{$regionals}}</p>
