          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="description-percentage text-danger">{{$sper}}%</span>
                <span class="info-box-number" style="color:blue">{{$stotal}}</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="description-percentage text-success">{{$aper}}%</span>
                <span class="info-box-number" style="color:blue">{{$atotal}}</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number" style="color:blue">{{$dtotal}}</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
            ...
            <div class="card">
              ...
              <div class="card-footer">
                <div class="row">
                  ...
                  <div class="col-sm-3 col-6">
                    <div class="description-block border-right">
                      <span class="description-percentage text-primary">{{$savp}}%</span>
                      <h5 class="description-header">{{$saved}}</h5>
                  ...
                  <div class="col-sm-3 col-6">
                    <div class="description-block border-right">
                      <span class="description-percentage text-success">{{$spp}}%</span>
                      <h5 class="description-header">{{$spent}}</h5>
