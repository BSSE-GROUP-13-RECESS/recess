                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="donor" type="text" class="form-control <?php $__errorArgs = ['donor'];
...
unset($__errorArgs, $__bag); ?>" name="donor" required autocomplete="donor" autofocus>

                                <?php $__errorArgs = ['donor'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" name="Date" required autocomplete="Date">
...
<?php echo $__env->make('layouts.AdminLTE', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DOC\Recess\Covid_casetool\resources\views/funds.blade.php ENDPATH**/ ?>