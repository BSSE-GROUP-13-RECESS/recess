        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo e(route('funds')); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Funds</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo e(route('promotions')); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Promotions</p>
                </a>
              </li>
              ...
              <li class="nav-item has-treeview">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="<?php echo e(route('regionallist')); ?>" class="nav-link">
                      <i class="far fa-plus-square nav-icon"></i>
                      <p>Regional referralwaiting List</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="<?php echo e(route('nationallist')); ?>" class="nav-link">
                      <i class="far fa-plus-square nav-icon"></i>
              ...
              <li class="nav-item has-treeview">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="<?php echo e(route('generalOfficers')); ?>" class="nav-link">
                      <i class="far fa-plus-square nav-icon"></i>
                      <p>General Hospital Officers</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="<?php echo e(route('regionalOfficers')); ?>" class="nav-link">
                      <i class="far fa-plus-square nav-icon"></i>
                      <p>Regional Referral Hospital Officers</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="<?php echo e(route('nationalOfficers')); ?>" class="nav-link">
                      <i class="far fa-plus-square nav-icon"></i>
...
<?php /**PATH D:\DOC\Recess\Covid_casetool\resources\views/layouts/adminLTE.blade.php ENDPATH**/ ?>