            ...
            <div class="card card-success">
              ...
              <div class="card-body form-inline">
                ...
                <label for="sele2" class="mr-sm-2" id="chng"> Select month: </label><select id="sele2" onchange="select('b')" class="form-control col"></select>
                  ...
                  <div>
                  <?php if($total_dona>0): ?>
                    <p id="info1" hidden><?php echo e(json_encode($byMonth)); ?></p>
                    <p id="info2" hidden><?php echo e(json_encode($byWell)); ?></p>
                  <?php else: ?>
                    No data to display
                  <?php endif; ?>
                </div>
...
<?php echo $__env->make('layouts.adminLTE', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/timothy/Desktop/Covid_casetool/resources/views/donations.blade.php ENDPATH**/ ?>